...
レポートサービスは412XX-413XX範囲のエラーコードを使用します：

### レポート基本操作関連 (4120X)
- `412001`: レポートが見つかりません
- `412002`: レポートのバリデーションエラー
- `412003`: レポート生成エラー
- `412004`: 不正なレポートタイプ
- `412005`: 不正なレポートスコープ
- `412006`: レポート日付エラー
...
### レポート検証関連 (4121XX)
- `412101`: 端末がクローズされていません
- `412102`: 必要なログが欠落しています
- `412103`: ログ数の不一致
- `412104`: トランザクションログが欠落しています
- `412105`: 入出金ログが欠落しています
- `412106`: 開閉店ログが欠落しています
- `412107`: データ検証に失敗しました
