...
| **JN-A-REC** | **Create a new journal entry.** | `API / POST` | ![Missing](https://img.shields.io/badge/Status-Missing-red) | `receive_journals` | システムが自動追加したAPIインターフェーステスト |
| **JN-A-GET** | **Retrieve journal entries with various filtering options.** | `API / GET` | ![Missing](https://img.shields.io/badge/Status-Missing-red) | `get_journals` | システムが自動追加したAPIインターフェーステスト |
| **JN-A-HAN** | **Handle transaction logs received via Dapr pub/sub.** | `API / POST` | ![Missing](https://img.shields.io/badge/Status-Missing-red) | `handle_tranlog` | システムが自動追加したAPIインターフェーステスト |
| **JN-A-HAN** | **Handle cash in/out logs received via Dapr pub/sub.** | `API / POST` | ![Missing](https://img.shields.io/badge/Status-Missing-red) | `handle_cashlog` | システムが自動追加したAPIインターフェーステスト |
| **JN-A-HAN** | **Handle terminal open/close logs received via Dapr pub/sub.** | `API / POST` | ![Missing](https://img.shields.io/badge/Status-Missing-red) | `handle_opencloselog` | システムが自動追加したAPIインターフェーステスト |
| **JN-A-REC** | **Direct API endpoint for receiving transaction data.** | `API / POST` | ![Missing](https://img.shields.io/badge/Status-Missing-red) | `receive_transactions` | システムが自動追加したAPIインターフェーステスト |
