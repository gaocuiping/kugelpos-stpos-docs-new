# ユニットテスト: update_store
# API: PUT /tenants/{tenant_id}/stores/{store_code}
# 実装日: 2026-03-10
...
@pytest.mark.asyncio
async def test_update_store_unit_success(async_client):
    """
    【正常系 | P0 ユニットテスト】
    PUT /tenants/{tenant_id}/stores/{store_code}
...
@pytest.mark.asyncio
async def test_update_store_unit_error_handling(async_client):
    """
    【異常系 | P0 ユニットテスト】
