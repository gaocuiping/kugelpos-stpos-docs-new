# ユニットテスト: get_stores
# API: GET /tenants/{tenant_id}/stores
# 実装日: 2026-03-10
...
@pytest.mark.asyncio
async def test_get_stores_unit_success(async_client):
    """
    【正常系 | P0 ユニットテスト】
    GET /tenants/{tenant_id}/stores
    ...
    try:
        response = await async_client.get(
            f"/api/v1/tenants/{test_test_tenant_id}/stores",
        )
...
@pytest.mark.asyncio
async def test_get_stores_unit_error_handling(async_client):
    """
    【異常系 | P0 ユニットテスト】
