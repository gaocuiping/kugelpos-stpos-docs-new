# テストケース: POST /terminals/{terminal_id}/cash-out
# API: terminal_cash_out
# 実装日: 2026-03-10
...
@pytest.mark.asyncio
async def test_terminal_cash_out_happy_path(
...
@pytest.mark.asyncio
async def test_terminal_cash_out_unauthorized(
    http_client: AsyncClient,
    test_tenant_id: str,
    test_store_code: str,
):
