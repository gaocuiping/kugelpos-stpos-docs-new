# テストケース: PATCH /terminals/{terminal_id}/description
# API: update_terminal_description
# 実装日: 2026-03-10
...
@pytest.mark.asyncio
async def test_update_terminal_description_happy_path(
...
@pytest.mark.asyncio
async def test_update_terminal_description_unauthorized(
    http_client: AsyncClient,
    test_tenant_id: str,
    test_store_code: str,
):
