# テストケース: PATCH /terminals/{terminal_id}/function_mode
# API: update_terminal_function_mode
# 実装日: 2026-03-10
...
@pytest.mark.asyncio
async def test_update_terminal_function_mode_happy_path(
    ...
    """
    test_terminal_id = "TEST_TERMINAL_ID"  # TODO: 有効な値に差し替えてください
...
@pytest.mark.asyncio
async def test_update_terminal_function_mode_unauthorized(
    http_client: AsyncClient,
    test_tenant_id: str,
    test_store_code: str,
):
