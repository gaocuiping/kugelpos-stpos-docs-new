# テストケース: GET /tenants/{tenant_id}/stores/{store_code}/reports
# API: get_report_for_store
# 実装日: 2026-03-10
...
@pytest.mark.asyncio
async def test_get_report_for_store_happy_path(
...
@pytest.mark.asyncio
async def test_get_report_for_store_unauthorized(
    http_client: AsyncClient,
    test_tenant_id: str,
    test_store_code: str,
):
