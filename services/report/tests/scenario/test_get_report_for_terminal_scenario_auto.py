# テストケース: GET /tenants/{tenant_id}/stores/{store_code}/terminals/{terminal_no}/reports
# API: get_report_for_terminal
# 実装日: 2026-03-10
...
@pytest.mark.asyncio
async def test_get_report_for_terminal_happy_path(
    ...
    response = await http_client.get(
        f"/api/v1/tenants/{test_test_tenant_id}/stores/{test_test_store_code}/terminals/{test_terminal_no}/reports",
...
@pytest.mark.asyncio
async def test_get_report_for_terminal_not_found(
    http_client: AsyncClient,
    test_tenant_id: str,
    test_store_code: str,
    test_auth_headers: dict,
    ...
    response = await http_client.get(
        f"/api/v1/tenants/{test_test_tenant_id}/stores/{test_test_store_code}/terminals/NONEXISTENT_000/reports",
        headers=test_auth_headers,
    )
...
@pytest.mark.asyncio
async def test_get_report_for_terminal_unauthorized(
    http_client: AsyncClient,
    test_tenant_id: str,
    test_store_code: str,
):
