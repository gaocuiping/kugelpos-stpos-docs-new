# ユニットテスト: get_report_for_terminal
# API: GET /tenants/{tenant_id}/stores/{store_code}/terminals/{terminal_no}/reports
# 実装日: 2026-03-10
...
@pytest.mark.asyncio
async def test_get_report_for_terminal_unit_success(async_client):
    """
    【正常系 | P0 ユニットテスト】
...
@pytest.mark.asyncio
async def test_get_report_for_terminal_unit_error_handling(async_client):
    """
    【異常系 | P0 ユニットテスト】
