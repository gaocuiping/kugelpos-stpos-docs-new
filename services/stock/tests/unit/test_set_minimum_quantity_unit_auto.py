# ユニットテスト: set_minimum_quantity
# API: PUT /tenants/{tenant_id}/stores/{store_code}/stock/{item_code}/minimum
# 実装日: 2026-03-10
...
@pytest.mark.asyncio
async def test_set_minimum_quantity_unit_success(async_client):
    """
    【正常系 | P0 ユニットテスト】
    PUT /tenants/{tenant_id}/stores/{store_code}/stock/{item_code}/minimum
...
@pytest.mark.asyncio
async def test_set_minimum_quantity_unit_error_handling(async_client):
    """
    【異常系 | P0 ユニットテスト】
