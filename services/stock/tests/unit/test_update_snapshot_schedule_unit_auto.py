# ユニットテスト: update_snapshot_schedule
# API: PUT /tenants/{tenant_id}/stock/snapshot-schedule
# 実装日: 2026-03-10
...
@pytest.mark.asyncio
async def test_update_snapshot_schedule_unit_success(async_client):
    """
    【正常系 | P0 ユニットテスト】
    PUT /tenants/{tenant_id}/stock/snapshot-schedule
...
@pytest.mark.asyncio
async def test_update_snapshot_schedule_unit_error_handling(async_client):
    """
    【異常系 | P0 ユニットテスト】
