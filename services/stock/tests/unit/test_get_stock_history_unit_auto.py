# ユニットテスト: get_stock_history
# API: GET /tenants/{tenant_id}/stores/{store_code}/stock/{item_code}/history
# 実装日: 2026-03-10
...
@pytest.mark.asyncio
async def test_get_stock_history_unit_success(async_client):
    """
    【正常系 | P0 ユニットテスト】
    GET /tenants/{tenant_id}/stores/{store_code}/stock/{item_code}/history
...
@pytest.mark.asyncio
async def test_get_stock_history_unit_error_handling(async_client):
    """
    【異常系 | P0 ユニットテスト】
