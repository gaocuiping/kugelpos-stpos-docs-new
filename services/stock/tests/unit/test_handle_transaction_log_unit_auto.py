# ユニットテスト: handle_transaction_log
# API: POST /tranlog
# 実装日: 2026-03-10
...
@pytest.mark.asyncio
async def test_handle_transaction_log_unit_success(async_client):
    """
    【正常系 | P0 ユニットテスト】
    POST /tranlog
...
@pytest.mark.asyncio
async def test_handle_transaction_log_unit_error_handling(async_client):
    """
    【異常系 | P0 ユニットテスト】
