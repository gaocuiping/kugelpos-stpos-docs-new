# テストケース: PUT /tenants/{tenant_id}/stores/{store_code}/stock/{item_code}/minimum
# API: set_minimum_quantity
# 実装日: 2026-03-10
...
@pytest.mark.asyncio
async def test_set_minimum_quantity_happy_path(
...
@pytest.mark.asyncio
async def test_set_minimum_quantity_unauthorized(
    http_client: AsyncClient,
    test_tenant_id: str,
    test_store_code: str,
):
