# ユニットテスト: delete_settings_master_async
# API: DELETE /tenants/{tenant_id}/settings/{name}
# 実装日: 2026-03-10
...
@pytest.mark.asyncio
async def test_delete_settings_master_async_unit_success(async_client):
    """
    【正常系 | P0 ユニットテスト】
    DELETE /tenants/{tenant_id}/settings/{name}
...
@pytest.mark.asyncio
async def test_delete_settings_master_async_unit_error_handling(async_client):
    """
    【異常系 | P0 ユニットテスト】
    ...
    pytest.skip(
        ...
        f" 対象: delete_settings_master_async"
    )
