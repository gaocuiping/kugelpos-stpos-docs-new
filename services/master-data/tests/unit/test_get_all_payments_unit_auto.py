# ユニットテスト: get_all_payments
# API: GET /tenants/{tenant_id}/payments
# 実装日: 2026-03-10
...
@pytest.mark.asyncio
async def test_get_all_payments_unit_success(async_client):
    """
    【正常系 | P0 ユニットテスト】
    GET /tenants/{tenant_id}/payments
...
@pytest.mark.asyncio
async def test_get_all_payments_unit_error_handling(async_client):
    """
    【異常系 | P0 ユニットテスト】
