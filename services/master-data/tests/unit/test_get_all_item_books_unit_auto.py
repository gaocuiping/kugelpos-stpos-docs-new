# ユニットテスト: get_all_item_books
# API: GET /tenants/{tenant_id}/item_books
# 実装日: 2026-03-10
...
@pytest.mark.asyncio
async def test_get_all_item_books_unit_success(async_client):
    """
    【正常系 | P0 ユニットテスト】
    GET /tenants/{tenant_id}/item_books
    ...
    try:
        response = await async_client.get(
            f"/api/v1/tenants/{test_test_tenant_id}/item_books",
        )
...
@pytest.mark.asyncio
async def test_get_all_item_books_unit_error_handling(async_client):
    """
    【異常系 | P0 ユニットテスト】
