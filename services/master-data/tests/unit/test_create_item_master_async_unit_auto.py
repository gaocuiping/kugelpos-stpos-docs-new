# ユニットテスト: create_item_master_async
...
@pytest.mark.asyncio
async def test_create_item_master_async_unit_success(async_client):
    """
    【正常系 | P0 ユニットテスト】
...
@pytest.mark.asyncio
async def test_create_item_master_async_unit_error_handling(async_client):
    """
    【異常系 | P0 ユニットテスト】
