# ユニットテスト: delete_payment
# API: DELETE /tenants/{tenant_id}/payments/{payment_code}
# 実装日: 2026-03-10
...
@pytest.mark.asyncio
async def test_delete_payment_unit_success(async_client):
    """
    【正常系 | P0 ユニットテスト】
    DELETE /tenants/{tenant_id}/payments/{payment_code}
...
@pytest.mark.asyncio
async def test_delete_payment_unit_error_handling(async_client):
    """
    【異常系 | P0 ユニットテスト】
