# ユニットテスト: create_category
# API: POST /tenants/{tenant_id}/categories
# 実装日: 2026-03-10
...
@pytest.mark.asyncio
async def test_create_category_unit_success(async_client):
    """
    【正常系 | P0 ユニットテスト】
    ...
    try:
        response = await async_client.post(
            f"/api/v1/tenants/{test_test_tenant_id}/categories",
        json={},
        )
...
@pytest.mark.asyncio
async def test_create_category_unit_error_handling(async_client):
    """
    【異常系 | P0 ユニットテスト】
