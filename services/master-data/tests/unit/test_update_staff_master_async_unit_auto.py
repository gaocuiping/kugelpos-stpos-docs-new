# ユニットテスト: update_staff_master_async
# API: PUT /tenants/{tenant_id}/staff/{staff_id}
# 実装日: 2026-03-10
...
@pytest.mark.asyncio
async def test_update_staff_master_async_unit_success(async_client):
    """
    【正常系 | P0 ユニットテスト】
...
@pytest.mark.asyncio
async def test_update_staff_master_async_unit_error_handling(async_client):
    """
    【異常系 | P0 ユニットテスト】
    ...
    pytest.skip(
        ...
        f" 対象: update_staff_master_async"
    )
