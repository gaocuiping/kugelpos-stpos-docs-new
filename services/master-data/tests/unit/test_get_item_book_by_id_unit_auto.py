# ユニットテスト: get_item_book_by_id
# API: GET /tenants/{tenant_id}/item_books/{item_book_id}
# 実装日: 2026-03-10
...
@pytest.mark.asyncio
async def test_get_item_book_by_id_unit_success(async_client):
    """
    【正常系 | P0 ユニットテスト】
...
@pytest.mark.asyncio
async def test_get_item_book_by_id_unit_error_handling(async_client):
    """
    【異常系 | P0 ユニットテスト】
