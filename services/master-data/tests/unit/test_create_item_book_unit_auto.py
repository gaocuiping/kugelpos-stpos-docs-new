# ユニットテスト: create_item_book
# API: POST /tenants/{tenant_id}/item_books
# 実装日: 2026-03-10
...
@pytest.mark.asyncio
async def test_create_item_book_unit_success(async_client):
    """
    【正常系 | P0 ユニットテスト】
    POST /tenants/{tenant_id}/item_books
...
@pytest.mark.asyncio
async def test_create_item_book_unit_error_handling(async_client):
    """
    【異常系 | P0 ユニットテスト】
