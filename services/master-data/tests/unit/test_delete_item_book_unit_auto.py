# ユニットテスト: delete_item_book
# API: DELETE /tenants/{tenant_id}/item_books/{item_book_id}
# 実装日: 2026-03-10
...
@pytest.mark.asyncio
async def test_delete_item_book_unit_success(async_client):
    """
    【正常系 | P0 ユニットテスト】
    DELETE /tenants/{tenant_id}/item_books/{item_book_id}
...
@pytest.mark.asyncio
async def test_delete_item_book_unit_error_handling(async_client):
    """
    【異常系 | P0 ユニットテスト】
