# テストケース: GET /tenants/{tenant_id}/item_books
# API: get_all_item_books
# 実装日: 2026-03-10
...
@pytest.mark.asyncio
async def test_get_all_item_books_happy_path(
...
@pytest.mark.asyncio
async def test_get_all_item_books_unauthorized(
    http_client: AsyncClient,
    test_tenant_id: str,
    test_store_code: str,
):
