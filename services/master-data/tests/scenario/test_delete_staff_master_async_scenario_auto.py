# テストケース: DELETE /tenants/{tenant_id}/staff/{staff_id}
# API: delete_staff_master_async
# 実装日: 2026-03-10
...
@pytest.mark.asyncio
async def test_delete_staff_master_async_happy_path(
...
@pytest.mark.asyncio
async def test_delete_staff_master_async_unauthorized(
    http_client: AsyncClient,
    test_tenant_id: str,
    test_store_code: str,
):
