# テストケース: GET /tenants/{tenant_id}/item_books/{item_book_id}
# API: get_item_book_by_id
# 実装日: 2026-03-10
...
@pytest.mark.asyncio
async def test_get_item_book_by_id_happy_path(
    ...
    """
    【正常系 | P1-4】
    GET /tenants/{tenant_id}/item_books/{item_book_id}
...
@pytest.mark.asyncio
async def test_get_item_book_by_id_not_found(
    http_client: AsyncClient,
    test_tenant_id: str,
    test_store_code: str,
    test_auth_headers: dict,
    ...
    response = await http_client.get(
        f"/api/v1/tenants/{test_test_tenant_id}/item_books/NONEXISTENT_000",
        headers=test_auth_headers,
    )
...
@pytest.mark.asyncio
async def test_get_item_book_by_id_unauthorized(
    http_client: AsyncClient,
    test_tenant_id: str,
    test_store_code: str,
):
