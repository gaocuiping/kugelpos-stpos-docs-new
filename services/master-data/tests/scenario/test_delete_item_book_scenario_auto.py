# テストケース: DELETE /tenants/{tenant_id}/item_books/{item_book_id}
# API: delete_item_book
# 実装日: 2026-03-10
...
@pytest.mark.asyncio
async def test_delete_item_book_happy_path(
...
@pytest.mark.asyncio
async def test_delete_item_book_unauthorized(
    http_client: AsyncClient,
    test_tenant_id: str,
    test_store_code: str,
):
