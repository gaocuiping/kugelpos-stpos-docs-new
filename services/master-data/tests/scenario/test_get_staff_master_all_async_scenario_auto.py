# テストケース: GET /tenants/{tenant_id}/staff
# API: get_staff_master_all_async
# 実装日: 2026-03-10
...
@pytest.mark.asyncio
async def test_get_staff_master_all_async_happy_path(
...
@pytest.mark.asyncio
async def test_get_staff_master_all_async_unauthorized(
    http_client: AsyncClient,
    test_tenant_id: str,
    test_store_code: str,
):
