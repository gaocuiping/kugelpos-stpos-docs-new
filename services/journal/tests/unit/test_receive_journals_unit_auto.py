# ユニットテスト: receive_journals
# API: POST /tenants/{tenant_id}/stores/{store_code}/terminals/{terminal_no}/journals
# 実装日: 2026-03-10
...
@pytest.mark.asyncio
async def test_receive_journals_unit_success(async_client):
    """
    【正常系 | P0 ユニットテスト】
...
@pytest.mark.asyncio
async def test_receive_journals_unit_error_handling(async_client):
    """
    【異常系 | P0 ユニットテスト】
