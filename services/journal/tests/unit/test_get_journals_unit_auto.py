# ユニットテスト: get_journals
# API: GET /tenants/{tenant_id}/stores/{store_code}/journals
# 実装日: 2026-03-10
...
@pytest.mark.asyncio
async def test_get_journals_unit_success(async_client):
    """
    【正常系 | P0 ユニットテスト】
    ...
    try:
        response = await async_client.get(
            f"/api/v1/tenants/{test_test_tenant_id}/stores/{test_test_store_code}/journals",
        )
...
@pytest.mark.asyncio
async def test_get_journals_unit_error_handling(async_client):
    """
    【異常系 | P0 ユニットテスト】
