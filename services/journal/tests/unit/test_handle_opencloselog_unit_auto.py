# ユニットテスト: handle_opencloselog
# API: POST /opencloselog
# 実装日: 2026-03-10
...
@pytest.mark.asyncio
async def test_handle_opencloselog_unit_success(async_client):
    """
    【正常系 | P0 ユニットテスト】
    POST /opencloselog
...
@pytest.mark.asyncio
async def test_handle_opencloselog_unit_error_handling(async_client):
    """
    【異常系 | P0 ユニットテスト】
