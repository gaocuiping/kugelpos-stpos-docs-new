# テストケース: POST /tenants/{tenant_id}/stores/{store_code}/terminals/{terminal_no}/transactions
# API: receive_transactions
# 実装日: 2026-03-10
...
@pytest.mark.asyncio
async def test_receive_transactions_happy_path(
...
@pytest.mark.asyncio
async def test_receive_transactions_unauthorized(
    http_client: AsyncClient,
    test_tenant_id: str,
    test_store_code: str,
):
